...
def main():
    ...
    savings_interest = float(
        input("Enter the annual interest rate for the savings account (in %): "))
    savings_maturity = int(
        input("Enter the number of months for the savings account: "))
    ...
    cd_interest = float(
        input("Enter the annual interest rate for the CD account (in %): "))
